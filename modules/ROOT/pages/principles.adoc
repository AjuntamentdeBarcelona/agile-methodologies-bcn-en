...
All this is based on the so-called “_Manifesto for the Agile Development of Software_”, of 2001:

[quote, , "Agile Manifesto, http://agilemanifesto.org/iso/ca/manifesto.html"]
____
...
[quote, Finnish agency responsible for driving licences, "Quoted in Nuottila et al. (2013), about an Agile project in the Transport Department"]
Development productivity was increased, the transparency of development activities was enhanced and the relative proportion of administrative work was reduced (by up to 25%).
