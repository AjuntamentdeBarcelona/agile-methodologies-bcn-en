...
:_public_repo_url: https://github.com/AjuntamentdeBarcelona/agile-methodologies-bcn-en
//
// MANDATORY.
:_url: https://barcelona.cat/digitalstandards/en/agile-methodologies/
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Agile Methodologies Guide
//
...
//
// OPTIONAL. Comma-separated list of names.
:_reviewers: Roberto di Cosmo, Javier Ruiz, Antonio Valle Salas
//
...
:keywords: ethical digital standards, technology rights, barcelona, city council, agile methodologies, scrum, imi
//
...
This document is part of the https://www.barcelona.cat/digitalstandards/[Ethical Digital Standards] of the Barcelona City Council.
